      ...
      >
        <div className="flex h-16 items-center justify-between px-6 lg:px-10">
          <div className="flex items-center gap-6">
            <Link
              className="hidden h-10 items-center justify-center bg-[#0f172a] px-7 text-[12px] font-bold uppercase tracking-widest text-white transition-all hover:bg-[#5a5c3b] active:scale-95 md:inline-flex"
              to="/contact"
            >
              ابدأ مشروعك
            </Link>
            ...
            <nav className="flex items-center gap-4" dir="rtl">
              {items.map((item) => (
                ...
                >
                  {item.label}
                  <span
                    className={`absolute bottom-0 left-5 right-5 h-[2px] origin-right bg-[#5a5c3b] transition-transform duration-500 ${
          ...
          >
            ...
            <span className="flex flex-col items-end border-r-2 border-slate-900 pr-4 text-right transition-all duration-500 group-hover:border-[#5a5c3b]">
          ...
          <nav className="flex flex-col py-6" id="site-nav">
            {items.map((item) => (
              <NavLink
                ...
                className="border-b border-slate-50 px-10 py-5 text-center text-[14px] font-black tracking-[0.15em] text-slate-700 transition-colors last:border-none hover:bg-slate-50 hover:text-[#5a5c3b]"
              >
                {item.label}
              </NavLink>
            ))}
            <div className="p-6">
              <Link
                className="flex h-14 items-center justify-center bg-[#0f172a] text-[13px] font-bold uppercase tracking-widest text-white transition-colors hover:bg-[#5a5c3b]"
                to="/contact"
              >
                ابدأ مشروعك الآن
              </Link>
